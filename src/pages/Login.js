...
import cover from '../electrosenseResources/images/IMG_0958.PNG'
...
export default ({
  ...
  headingText = "Sign In To Electrosense",
  socialButtons = [  
  ],
...
const handleSubmit=async (e)=>{
  ...
  try {
    ...
    if (response.status === 200) {
      ...
      toast.error("Failed to Login !" ,{position: "top-right", autoClose: 5000, theme: "dark"})  
    }
  } catch (error) {
    toast.error("Error Login !" ,{position: "top-right", autoClose: 5000, theme: "dark"})  
  }
